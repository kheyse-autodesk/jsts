...
module.exports = MinimumDiameter
...
MinimumDiameter.prototype.getWidthCoordinate = function () {
	this.computeMinimumDiameter();
	return this.minWidthPt;
};
MinimumDiameter.prototype.getSupportingSegment = function () {
	this.computeMinimumDiameter();
	return this.inputGeom.getFactory().createLineString([this.minBaseSeg.p0, this.minBaseSeg.p1]);
};
MinimumDiameter.prototype.getDiameter = function () {
	this.computeMinimumDiameter();
...
MinimumDiameter.prototype.computeWidthConvex = function (convexGeom) {
...
MinimumDiameter.prototype.computeConvexRingMinDiameter = function (pts) {
...
MinimumDiameter.prototype.computeMinimumDiameter = function () {
...
MinimumDiameter.prototype.getLength = function () {
	this.computeMinimumDiameter();
	return this.minWidth;
};
MinimumDiameter.prototype.findMaxPerpDistance = function (pts, seg, startIndex) {
...
MinimumDiameter.prototype.getMinimumRectangle = function () {
	this.computeMinimumDiameter();
