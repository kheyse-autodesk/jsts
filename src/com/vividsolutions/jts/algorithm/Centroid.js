...
Centroid.prototype.addPoint = function (pt) {
	this.ptCount += 1;
	this.ptCentSum.x += pt.x;
	this.ptCentSum.y += pt.y;
};
Centroid.prototype.setBasePoint = function (basePt) {
	if (this.areaBasePt === null) this.areaBasePt = basePt;
};
Centroid.prototype.addLineSegments = function (pts) {
	var lineLen = 0.0;
...
Centroid.prototype.addHole = function (pts) {
...
Centroid.prototype.getCentroid = function () {
...
Centroid.prototype.addShell = function (pts) {
...
Centroid.prototype.addTriangle = function (p0, p1, p2, isPositiveArea) {
...
Centroid.prototype.add = function (...args) {
	switch (args.length) {
		case 1:
