...
LineIntersector.prototype.getIndexAlongSegment = function (segmentIndex, intIndex) {
	this.computeIntLineIndex();
	return this.intLineIndex[segmentIndex][intIndex];
};
LineIntersector.prototype.getTopologySummary = function () {
...
LineIntersector.prototype.computeIntersection = function (p1, p2, p3, p4) {
...
LineIntersector.prototype.getIntersectionNum = function () {
	return this.result;
};
LineIntersector.prototype.computeIntLineIndex = function (...args) {
	switch (args.length) {
		case 1:
			return ((...args) => {
...
LineIntersector.prototype.isProper = function () {
	return this.hasIntersection() && this.isProper;
};
LineIntersector.prototype.setPrecisionModel = function (precisionModel) {
	this.precisionModel = precisionModel;
};
LineIntersector.prototype.isInteriorIntersection = function (...args) {
	switch (args.length) {
		case 1:
			return ((...args) => {
...
LineIntersector.prototype.getIntersection = function (intIndex) {
	return this.intPt[intIndex];
};
LineIntersector.prototype.isEndPoint = function () {
	return this.hasIntersection() && !this.isProper;
};
LineIntersector.prototype.hasIntersection = function () {
	return this.result !== LineIntersector.NO_INTERSECTION;
};
LineIntersector.prototype.getEdgeDistance = function (segmentIndex, intIndex) {
...
LineIntersector.prototype.isCollinear = function () {
	return this.result === LineIntersector.COLLINEAR_INTERSECTION;
};
LineIntersector.prototype.toString = function () {
...
LineIntersector.prototype.setMakePrecise = function (precisionModel) {
	this.precisionModel = precisionModel;
};
LineIntersector.prototype.getEndpoint = function (segmentIndex, ptIndex) {
	return this.inputLines[segmentIndex][ptIndex];
};
LineIntersector.prototype.isIntersection = function (pt) {
	for (var i = 0; i < this.result; i++) {
...
LineIntersector.prototype.getIntersectionAlongSegment = function (segmentIndex, intIndex) {
	this.computeIntLineIndex();
