function NonRobustCGAlgorithms() {
	if (arguments.length === 0) return;
}
module.exports = NonRobustCGAlgorithms
var CGAlgorithms = require('com/vividsolutions/jts/algorithm/CGAlgorithms');
var util = require('util');
util.inherits(NonRobustCGAlgorithms, CGAlgorithms)
NonRobustCGAlgorithms.orientationIndex = function (p1, p2, q) {
	var dx1 = p2.x - p1.x;
	var dy1 = p2.y - p1.y;
	var dx2 = q.x - p2.x;
	var dy2 = q.y - p2.y;
...
NonRobustCGAlgorithms.distanceLineLine = function (A, B, C, D) {
...
NonRobustCGAlgorithms.isPointInRing = function (p, ring) {
	var i = null, i1 = null;
	var xInt = null;
	var crossings = 0;
...
NonRobustCGAlgorithms.isCCW = function (ring) {
...
NonRobustCGAlgorithms.computeOrientation = function (p1, p2, q) {
