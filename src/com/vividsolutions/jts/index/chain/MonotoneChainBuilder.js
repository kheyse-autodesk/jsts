...
module.exports = MonotoneChainBuilder
var MonotoneChain = require('com/vividsolutions/jts/index/chain/MonotoneChain');
...
MonotoneChainBuilder.getChains = function (...args) {
	switch (args.length) {
		case 2:
			return ((...args) => {
