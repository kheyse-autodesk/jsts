function InteriorIntersectionFinderAdder(li) {
	this.li = null;
...
module.exports = InteriorIntersectionFinderAdder
var ArrayList = require('java/util/ArrayList');
InteriorIntersectionFinderAdder.prototype.processIntersections = function (e0, segIndex0, e1, segIndex1) {
...
InteriorIntersectionFinderAdder.prototype.isDone = function () {
	return false;
};
InteriorIntersectionFinderAdder.prototype.getInteriorIntersections = function () {
