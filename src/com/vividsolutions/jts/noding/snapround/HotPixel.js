function HotPixel(pt, scaleFactor, li) {
	this.li = null;
	this.pt = null;
...
HotPixel.prototype.intersectsScaled = function (p0, p1) {
...
HotPixel.prototype.initCorners = function (pt) {
	var tolerance = 0.5;
...
HotPixel.prototype.intersects = function (p0, p1) {
...
HotPixel.prototype.scale = function (val) {
	return Math.round(val * this.scaleFactor);
};
HotPixel.prototype.getCoordinate = function () {
	return this.originalPt;
};
HotPixel.prototype.copyScaled = function (p, pScaled) {
	pScaled.x = this.scale(p.x);
	pScaled.y = this.scale(p.y);
};
HotPixel.prototype.getSafeEnvelope = function () {
...
HotPixel.prototype.intersectsPixelClosure = function (p0, p1) {
...
HotPixel.prototype.intersectsToleranceSquare = function (p0, p1) {
...
HotPixel.prototype.addSnappedNode = function (segStr, segIndex) {
