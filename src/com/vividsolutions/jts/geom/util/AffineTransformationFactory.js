function AffineTransformationFactory() {}
module.exports = AffineTransformationFactory
var Coordinate = require('com/vividsolutions/jts/geom/Coordinate');
var AffineTransformation = require('com/vividsolutions/jts/geom/util/AffineTransformation');
var AffineTransformationBuilder = require('com/vividsolutions/jts/geom/util/AffineTransformationBuilder');
...
AffineTransformationFactory.createFromControlVectors = function (...args) {
	switch (args.length) {
		case 2:
