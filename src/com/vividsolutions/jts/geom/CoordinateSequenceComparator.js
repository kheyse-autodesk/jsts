function CoordinateSequenceComparator(...args) {
...
module.exports = CoordinateSequenceComparator
var Double = require('java/lang/Double');
CoordinateSequenceComparator.prototype.compare = function (o1, o2) {
	var s1 = o1;
	var s2 = o2;
	var size1 = s1.size();
	var size2 = s2.size();
...
CoordinateSequenceComparator.prototype.compareCoordinate = function (s1, s2, i, dimension) {
