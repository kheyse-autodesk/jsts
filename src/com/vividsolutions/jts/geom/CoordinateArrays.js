...
module.exports = CoordinateArrays
...
CoordinateArrays.equals = function (...args) {
	switch (args.length) {
		case 2:
			return ((...args) => {
...
CoordinateArrays.copyDeep = function (...args) {
	switch (args.length) {
		case 5:
			return ((...args) => {
...
ForwardComparator.prototype.compare = function (o1, o2) {
	var pts1 = o1;
	var pts2 = o2;
...
BidirectionalComparator.prototype.compare = function (o1, o2) {
	var pts1 = o1;
	var pts2 = o2;
...
BidirectionalComparator.prototype.OLDcompare = function (o1, o2) {
	var pts1 = o1;
	var pts2 = o2;
	if (pts1.length < pts2.length) return -1;
	if (pts1.length > pts2.length) return 1;
