...
export default class Geometry {
	...
	static get SORTINDEX_POINT() {
		return 0;
	}
	static get SORTINDEX_MULTIPOINT() {
		return 1;
	}
	static get SORTINDEX_LINESTRING() {
		return 2;
	}
	static get SORTINDEX_LINEARRING() {
		return 3;
	}
	static get SORTINDEX_MULTILINESTRING() {
		return 4;
	}
	static get SORTINDEX_POLYGON() {
		return 5;
	}
	static get SORTINDEX_MULTIPOLYGON() {
		return 6;
	}
	static get SORTINDEX_GEOMETRYCOLLECTION() {
		return 7;
	}
	static get geometryChangedFilter() {
		return new (class {
			filter(geom) {
