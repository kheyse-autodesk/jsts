...
var PlanarPolygon3D = require('com/vividsolutions/jts/operation/distance3d/PlanarPolygon3D');
...
var CGAlgorithms3D = require('com/vividsolutions/jts/algorithm/CGAlgorithms3D');
Distance3DOp.prototype.computeMinDistancePolygonPoint = function (polyPlane, point, flip) {
...
Distance3DOp.prototype.intersection = function (poly, line) {
...
Distance3DOp.prototype.computeMinDistancePolygonPolygon = function (poly0, poly1, flip) {
...
Distance3DOp.prototype.computeMinDistancePointPoint = function (point0, point1, flip) {
...
Distance3DOp.prototype.computeMinDistanceMultiMulti = function (g0, g1, flip) {
...
Distance3DOp.prototype.computeMinDistanceOneMulti = function (...args) {
	switch (args.length) {
		case 3:
			if (args[2] instanceof boolean && args[0] instanceof Geometry && args[1] instanceof Geometry) {
				return ((...args) => {
					let [g0, g1, flip] = args;
			...
			} else if (args[2] instanceof boolean && args[0] instanceof PlanarPolygon3D && args[1] instanceof Geometry) {
				return ((...args) => {
...
Distance3DOp.prototype.computeMinDistanceLinePoint = function (line, point, flip) {
...
Distance3DOp.prototype.nearestLocations = function () {
	this.computeMinDistance();
	return this.minDistanceLocation;
};
Distance3DOp.prototype.nearestPoints = function () {
	this.computeMinDistance();
	var nearestPts = [this.minDistanceLocation[0].getCoordinate(), this.minDistanceLocation[1].getCoordinate()];
	return nearestPts;
};
Distance3DOp.prototype.computeMinDistance = function (...args) {
	switch (args.length) {
		case 3:
			return ((...args) => {
				let [g0, g1, flip] = args;
...
Distance3DOp.prototype.computeMinDistanceLineLine = function (line0, line1, flip) {
...
Distance3DOp.prototype.computeMinDistancePolygonLine = function (poly, line, flip) {
...
Distance3DOp.prototype.distance = function () {
...
Distance3DOp.prototype.mostPolygonalIndex = function () {
...
Distance3DOp.prototype.computeMinDistancePolygonRings = function (poly, ringPoly, flip) {
...
Distance3DOp.prototype.updateDistance = function (dist, loc0, loc1, flip) {
	this.minDistance = dist;
	var index = flip ? 1 : 0;
